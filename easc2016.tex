...
\hline
 ...
 \hline
Mira & IBM BG/Q & $786,432$ &5D torus& $16$ & $5000$ & $5$\\ 
Titan & Cray XK7 & $299,008$ &3D torus& $16$ & $*$ & $*$\\ 
Beskow & Cray XC40 & $53,632$ &DragonFly& $32$ & $*$ & $*$\\
\hline
\end{tabular}
...
The geometry is meshed using hexheadral elements, partioned for parallel computation using a spectral bisection algorithm as implemented in "genmap" which accompanies the code Nek5000 (insert ref documentation and check if the genmap description is still in.. and give it to gail for once!!!!)
\begin{figure}
  \centering
  \subfigure[partition]{
