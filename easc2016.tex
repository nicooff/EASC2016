...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{./figures/histogram.eps}
  \caption{Histogram of the load imbalance, for the case: $2.184\times 10^9$ degrees of freedom. Time is centered}
...
numbers, represented by red dashed line in \reffig{fig:cachemisses} below which all gridpoints would theoratically fit into cache. As we run with 2 processes per core, this would be at roughly 1000
