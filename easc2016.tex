...
In order to assess the performance of the machines we have used, we needed to compute some of the network characteristics that determine the communication. In particular Beskow, which is a relatively new machine, had no such parameters provided to users. 
