...
(Beskow and Titan) or by the algorithmic limit of having at least one element per process, since as noted in \refsec{sec:code}, the smallest parallelizable unit in Nek5000 is one spectral element. 
