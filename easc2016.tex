...
$$
\noindent is equal to $0$. This rather an upper bound of the strong scaling
...
In \cite{fischer:scaling} the strong scaling limit (see \refeqn{eq:strong}) was estimated
...
$r=1$ increases significantly with bigger cases as we see from Table \reffig{tab:stronglimit}.
