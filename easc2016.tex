...
\title{On Strong Scaling of Nek5000 on Petascale Systems}
\subtitle{Subtitle}
%
...
\reftab{tab:computer_charac}. The systems vary from low to large petascale and help to
...
\begin{table}  
  ...
  in degrees of freedom per core $\frac{n}{P}$ with 2 processes per core on Mira}
