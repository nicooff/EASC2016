...
=======
  computation (single), total (ticked), computational linear scaling
>>>>>>> 9d2b7372f949f7e5febb279eee4b4c86550d74e4
  ({\color{green}green})}
...
This limitation cannot be explained from the non-dimensional latencies and bandwidths from \reftab{tab:alpha_beta}, as we do not expect the non-dimensional latency $\alpha$ to have simlar values on Titan and Mira. 
...
>>>>>>> 4f8989fbefc34168c3499f82f8adbb2cfbfe4340
