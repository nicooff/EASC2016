...
%1000: 2048-32768
a=[180, 360, 550, 1000];
b=[2 4 8 16 32 64 128 256 512 1024 2048 4096 8192 16384 32768]; 
...
loglog(procs(:,i),totalxxt(:,i),'-rs', 'linewidth',2)
loglog(procs(:,i),refamg(:,i),'g', 'linewidth',2)
loglog(procs(:,i),compamg(:,i),'b', 'linewidth',2)
loglog(procs(:,i),commamg(:,i),'b--', 'linewidth',2)
loglog(procs(:,i),totalamg(:,i),'-bs', 'linewidth',2)
x0=10;
y0=10;
width=500;
height=300;
